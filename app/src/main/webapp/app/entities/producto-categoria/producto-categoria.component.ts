...
export default class ProductoCategoria extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllProductoCategorias();
  }
  ...
  public retrieveAllProductoCategorias(): void {
  ...
  public prepareRemove(instance: IProductoCategoria): void {
  ...
  public removeProductoCategoria(): void {
    this.productoCategoriaService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('deliveryApp.productoCategoria.deleted', { param: this.removeId });
