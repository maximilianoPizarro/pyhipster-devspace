      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('deliveryApp.country.countryName')" for="country-countryName">Country Name</label>
            <input
              type="text"
              class="form-control"
              name="countryName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('deliveryApp.country.region')" for="country-region">Region</label>
