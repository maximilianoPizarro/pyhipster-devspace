      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            ...
            >
              <option
                v-for="ordenStatus in ordenStatusValues"
                :key="ordenStatus"
                v-bind:value="ordenStatus"
                v-bind:label="$t('deliveryApp.OrdenStatus.' + ordenStatus)"
              >
                {{ ordenStatus }}
              </option>
            </select>
          ...
          <div class="form-group">
            ...
            >
              <option
                v-for="metodoDePago in metodoDePagoValues"
                :key="metodoDePago"
                v-bind:value="metodoDePago"
                v-bind:label="$t('deliveryApp.MetodoDePago.' + metodoDePago)"
              >
                {{ metodoDePago }}
              </option>
            </select>
