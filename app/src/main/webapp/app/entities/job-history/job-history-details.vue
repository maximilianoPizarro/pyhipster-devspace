    ...
    <div class="col-8">
      <div v-if="jobHistory">
        <h2 class="jh-entity-heading" data-cy="jobHistoryDetailsHeading">
          <span v-text="$t('deliveryApp.jobHistory.detail.title')">JobHistory</span> {{ jobHistory.id }}
        </h2>
        <dl class="row jh-entity-details">
          ...
          <dd>
            <span v-text="$t('deliveryApp.Language.' + jobHistory.language)">{{ jobHistory.language }}</span>
          </dd>
          <dt>
