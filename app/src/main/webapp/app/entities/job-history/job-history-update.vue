      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('deliveryApp.jobHistory.startDate')" for="job-history-startDate">Start Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('deliveryApp.jobHistory.endDate')" for="job-history-endDate">End Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('deliveryApp.jobHistory.language')" for="job-history-language">Language</label>
            <select
              class="form-control"
              name="language"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('deliveryApp.jobHistory.job')" for="job-history-job">Job</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('deliveryApp.jobHistory.department')" for="job-history-department"
              >Department</label
            >
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('deliveryApp.jobHistory.employee')" for="job-history-employee">Employee</label>
