      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('deliveryApp.department.departmentName')" for="department-departmentName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('deliveryApp.department.location')" for="department-location">Location</label>
