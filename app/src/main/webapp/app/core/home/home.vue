<template>
  <div class="home row">
    ...
    <div class="col-md-9">
      <h1 class="display-4" v-text="$t('home.title')">Welcome, Python Hipster!</h1>
      ...
      <p v-text="$t('home.question')">If you have any question on PyHipster:</p>

      <ul>
        <li>
          <a
            href="https://github.com/pyhipster/generator-pyhipster"
            target="_blank"
            rel="noopener noreferrer"
            v-text="$t('home.link.homepage')"
            >PyHipster homepage</a
          >
        </li>
        <li>
          <a
            href="http://stackoverflow.com/tags/pyhipster/info"
            target="_blank"
            rel="noopener noreferrer"
            v-text="$t('home.link.stackoverflow')"
            >PyHipster on Stack Overflow</a
          >
        </li>
        <li>
          <a
            href="https://github.com/pyhipster/generator-pyhipster/issues?state=open"
            target="_blank"
            rel="noopener noreferrer"
            v-text="$t('home.link.bugtracker')"
            >PyHipster bug tracker</a
          >
        </li>
        <li>
          <a href="https://twitter.com/py_hipster" target="_blank" rel="noopener noreferrer" v-text="$t('home.link.follow')"
            >follow @py_hipster on Twitter</a
          >
        </li>
      ...
      <p>
        <span v-text="$t('home.like')">If you like PyHipster, don't forget to give us a star on</span>
        <a href="https://github.com/pyhipster/generator-pyhipster" target="_blank" rel="noopener noreferrer" v-text="$t('home.github')"
          >GitHub</a
        >!
      </p>
    </div>
