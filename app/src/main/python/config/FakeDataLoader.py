...
def load_fake_data(app):
    with app.app_context():
        ...
        data_load_object = [
            ...
            {"table": "Producto", "file": "Producto.csv", "file_location": user_fake_data},
            {"table": "ProductoCategoria", "file": "ProductoCategoria.csv", "file_location": user_fake_data},
            {"table": "Cliente", "file": "Cliente.csv", "file_location": user_fake_data},
            {"table": "Carrito", "file": "Carrito.csv", "file_location": user_fake_data},
            {"table": "ProductoOrden", "file": "ProductoOrden.csv", "file_location": user_fake_data},
